        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            button_updSet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!send.equals("")) {
                        t1.sendMsg("set:"+send.substring(0,send.length()-1));
                    }
                }
            });
                ...
                public void handleMessage(Message msg) {
                    switch (msg.what) {
                        case 1:
                            ...
                            String rec=""+msg.obj;
                            int ind1=rec.indexOf("'v'");
                            int ind2=rec.indexOf("'",ind1+6);
                            String rec2=rec.substring(ind1+5,ind2);
